...
export default function ClientPage() {
  ...
  const isHandNearFace = (handLandmarks: any[], threshold: number) => {
    ...
    const thumbBelowNose = thumbTip.y > nose.y;
    const indexBelowNose = indexTip.y > nose.y;
    return wristDist < threshold && thumbBelowNose && indexBelowNose;
  };
  ...
  const drawLandmarks = (landmarks: any[], color: string, radius: number, showPinch: boolean = false) => {
    ...
    // Draw thumb and index tips if showing pinch
    if (showPinch) {
